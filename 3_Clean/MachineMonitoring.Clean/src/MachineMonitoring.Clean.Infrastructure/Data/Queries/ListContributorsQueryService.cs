using MachineMonitoring.Clean.UseCases.Contributors;
using MachineMonitoring.Clean.UseCases.Contributors.List;

namespace MachineMonitoring.Clean.Infrastructure.Data.Queries;
