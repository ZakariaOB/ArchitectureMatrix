using MachineMonitoring.Clean.UseCases.Contributors.Get;
using MachineMonitoring.Clean.UseCases.Contributors.Update;

namespace MachineMonitoring.Clean.Web.Contributors;
