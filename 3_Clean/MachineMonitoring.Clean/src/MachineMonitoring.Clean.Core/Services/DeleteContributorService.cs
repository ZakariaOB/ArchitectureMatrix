using MachineMonitoring.Clean.Core.ContributorAggregate;
using MachineMonitoring.Clean.Core.ContributorAggregate.Events;
using MachineMonitoring.Clean.Core.Interfaces;


namespace MachineMonitoring.Clean.Core.Services;
