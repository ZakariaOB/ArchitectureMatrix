...
To update the database use this command from the Web project folder (replace `MachineMonitoring.Clean` with your project's name):

```powershell
dotnet ef database update -c AppDbContext -p ../MachineMonitoring.Clean.Infrastructure/MachineMonitoring.Clean.Infrastructure.csproj -s MachineMonitoring.Clean.Web.csproj
```
