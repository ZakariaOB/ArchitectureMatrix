...
1. Set `MachineMonitoringClean10.AspireHost` as the startup project
...
```bash
dotnet ef migrations add MigrationName -c AppDbContext -p ../MachineMonitoringClean10.Infrastructure/MachineMonitoringClean10.Infrastructure.csproj -s MachineMonitoringClean10.Web.csproj -o Data/Migrations
```
