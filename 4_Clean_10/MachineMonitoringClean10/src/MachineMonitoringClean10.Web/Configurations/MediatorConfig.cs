...
using MachineMonitoringClean10.Infrastructure;
using MachineMonitoringClean10.UseCases.Contributors.Create;

namespace MachineMonitoringClean10.Web.Configurations;
