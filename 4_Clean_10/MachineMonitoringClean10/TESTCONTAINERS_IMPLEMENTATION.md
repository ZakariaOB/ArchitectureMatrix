...
**Updated `tests\MachineMonitoringClean10.FunctionalTests\MachineMonitoringClean10.FunctionalTests.csproj`:**
- Removed: `Microsoft.EntityFrameworkCore.InMemory`
- Added: `Testcontainers` and `Testcontainers.MsSql`

### 2. CustomWebApplicationFactory

**File:** `tests\MachineMonitoringClean10.FunctionalTests\CustomWebApplicationFactory.cs`
...
```bash
dotnet test tests\MachineMonitoringClean10.FunctionalTests\MachineMonitoringClean10.FunctionalTests.csproj
```
