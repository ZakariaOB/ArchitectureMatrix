...
using MachineMonitoringClean10.Core.ProjectAggregate;
using MachineMonitoringClean10.Core.Services;
using MachineMonitoringClean10.SharedKernel.Interfaces;
using Moq;
using Xunit;

namespace MachineMonitoringClean10.UnitTests.Core.Services
{
