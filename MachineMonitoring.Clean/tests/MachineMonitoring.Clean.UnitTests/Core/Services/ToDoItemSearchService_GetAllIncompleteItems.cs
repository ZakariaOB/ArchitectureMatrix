...
using MachineMonitoring.Clean.Core.ProjectAggregate;
using MachineMonitoring.Clean.Core.Services;
using MachineMonitoring.Clean.SharedKernel.Interfaces;
using Moq;
using Xunit;

namespace MachineMonitoring.Clean.UnitTests.Core.Services
{
